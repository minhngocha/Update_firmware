...
namespace testerApp
{
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError { get { return testerApp.Logger.ERROR.Equals(Level, StringComparison.Ordinal); } }
        public bool IsWarning { get { return testerApp.Logger.WARN.Equals(Level, StringComparison.Ordinal); } }
        public bool IsInformation { get { return testerApp.Logger.INFO.Equals(Level, StringComparison.Ordinal); } }
        public bool IsDebug { get { return testerApp.Logger.DEBUG.Equals(Level, StringComparison.Ordinal); } }
